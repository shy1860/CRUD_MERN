...
class Chat extends Component {
    componentDidMount() {
        ...
        dispatch(chatAction.getChat());
    }
    handleChange = chat => {
        this.setState({
            anchor: chat.target.value,
        });
    };
                              ...
                              return (
                                  <TableRow key={n._id}>
                                    ...
                                    {/* <TableCell>
                                        ...
                                        <IconButton className={classes.button} aria-label="Delete" onClick={(Chat) => this.handleClick(Chat, n._id)}>
                                           <DeleteIcon /> 
                                        </IconButton>
                                    </TableCell> */}
                                 </TableRow>
...
const connectedChatPage = withRouter(connect(mapStateToProps, null, null, {
    pure: false
